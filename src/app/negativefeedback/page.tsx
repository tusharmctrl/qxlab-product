...
import NegativeGraph from "../../../public/image/negative-graph.png";
        ...
        <div className="flex flex-wrap justify-between">
          <div className="relative -mx-5 flex space-y-3">
            <div className="w-1/2 px-5">
              <ul className="!mt-2 list-none gap-10 space-y-6 text-white">
                <li className="space-y-1">
                  <p className="text-xl font-bold text-white">Emerging Negative Topics and  illustrative comments </p>
                  <p className="text-xl font-light text-white">last 30 days</p>
                </li>
                <li className="space-y-1">
                  <p className="text-xl font-bold text-white">Bet slip </p>
                  <p className="text-xl font-light text-white">When trying to place a multibet, as soon I select my first selection bet slip BLOCKS view of other selections and markets. Should be able to move bet slip out of sight and back again, like at other bookies. Have told them about this but they take NO notice. Also if I list several selections in a multibet they then log me out. Having re logged in then have to reselect my picks as they have wiped out the original bet slip. Infuriating.
                  Date of experience: July 18, 2024 and drop-off rates.</p>
                </li>
                <li className="space-y-1">
                  <p className="text-xl font-bold text-white">Online Laggy Experience </p>
                  <p className="text-xl font-light text-white">
                  The experience online was terrible. The online bet365 on a browser would throw so many errors every 3-4 attempts on the slots casino.

                  </p>
                 
                </li>
                <li className="space-y-1">
                  <p className="text-xl font-bold text-white">Deposit </p>
                  <p className="text-xl font-light text-white">
                  $100 n did not receive my bonus bets as promised im the sign up offer.
                  When I contacted customer service they credited me $10. I’ll go back to playing Play Alberta
                  </p>
            ...
            <div className="w-1/2 px-5">
              ...
              <div className="mt-16">
                <Image src={NegativeGraph} alt="Perception" />
              </div>
            </div>
          </div>
        </div>
